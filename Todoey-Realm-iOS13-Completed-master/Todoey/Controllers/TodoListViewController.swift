    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let colourHex = selectedCategory?.colour {
            ...
            if let navBarColour = UIColor(hexString: colourHex) {
                ...
                navBar.backgroundColor = navBarColour     //Navigation background olor belirler
                navBar.tintColor = ContrastColorOf(navBarColour, returnFlat: true) // Navigation text ve icon color
